...
export declare type LocalExplorerWorkflowInstanceStatus = WorChangeStatusWorkflowInstanceData["body"]["status"];

export declare type LocalExplorerWorkflowInstanceStatusResult = WorChangeStatusWorkflowInstanceResponses[200]["result"];
...
export declare type WorChangeStatusWorkflowInstanceData = {
    body: {
        status: "pause";
    } | {
        status: "resume";
...
export declare type WorChangeStatusWorkflowInstanceResponses = {
    /**
...
export declare interface Worker_DurableObjectNamespace_ContainerOptions_NamedImage {
    name?: string;
    image?: string;
}
